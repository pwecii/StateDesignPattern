...
<p>A vending machine needs to manage different states, including <strong>Idle</strong>, <strong>ItemSelected</strong>, <strong>Dispensing</strong>, and <strong>OutOfOrder</strong>. Each state has specific rules and restrictions regarding allowed operations, and the vending machine has associated attributes like item inventory and balance.</p>
